        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto border border-green-200">
            <p className="text-lg md:text-xl font-semibold text-green-700 leading-relaxed mb-4">
              "मोक्षमा में घर लेना है पर कोई नौरी धंधा नहीं है तो आप हमे अपनी Skills बताइये हम आपको Employment देने के प्रयत्न में है"
            </p>
            <p className="text-sm text-green-600 italic">
              "Want a home in Mokshamaa but don't have a job? Tell us your skills and we will try to provide you
              employment"
            </p>
          </div>
        </div>
